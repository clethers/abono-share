                  ...
                  <section className="card-theme lg:col-span-2 glass">
                    ...
                    <div className="p-4 grid grid-cols-3 gap-3">
                      {['Primary', 'Secondary', 'Tertiary'].map((label, i) => (
                        <div key={label} className="flex flex-col items-center justify-center gap-2 p-3 rounded-xl bg-[#F4F7F9]/50 border border-border-theme group cursor-pointer hover:bg-white hover:border-brand transition-all">
